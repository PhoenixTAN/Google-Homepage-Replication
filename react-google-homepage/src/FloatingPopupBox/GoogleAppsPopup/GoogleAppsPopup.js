...
const GoogleAppsPopup = () => {
    ...
    // console.log('GoogleAppsPopup rendering...');
    return (
        <div className="google-apps-popup flexbox">
            <div className="apps-icon-section flexbox">
                <a className="app-icon" href="/">
                    <img alt="" className="app-icon-image" src={account_icon}></img>
                    <span className="app-icon-name">Account</span>
                </a>
                <a className="app-icon" href="/">
                    <img alt="" className="app-icon-image" src={search_icon}></img>
                    <span className="app-icon-name">Search</span>
                </a>
                <a className="app-icon" href="/">
                    <img alt="" className="app-icon-image" src={maps_icon}></img>
                    <span className="app-icon-name">Maps</span>
                </a>
                <a className="app-icon" href="/">
                    <img alt="" className="app-icon-image" src={youtube_icon}></img>
                    <span className="app-icon-name">Youtube</span>
                </a>
                <a className="app-icon" href="/">
                    <img alt="" className="app-icon-image" src={play_icon}></img>
                    <span className="app-icon-name">Play</span>
                </a>
                <a className="app-icon" href="/">
                    <img alt="" className="app-icon-image" src={news_icon}></img>
                    <span className="app-icon-name">News</span>
                </a>
                <a className="app-icon" href="/">
                    <img alt="" className="app-icon-image" src={gmail_icon}></img>
                    <span className="app-icon-name">Gmail</span>
                </a>
                <a className="app-icon" href="/">
                    <img alt="" className="app-icon-image" src={contacts_icon}></img>
                    <span className="app-icon-name">Contacts</span>
                </a>
                <a className="app-icon" href="/">
                    <img alt="" className="app-icon-image" src={drive_icon}></img>
                    <span className="app-icon-name">Drive</span>
                </a>
                <a className="app-icon" href="/">
                    <img alt="" className="app-icon-image" src={calendar_icon}></img>
                    <span className="app-icon-name">Calendar</span>
                </a>
                <a className="app-icon" href="/">
                    <img alt="" className="app-icon-image" src={translate_icon}></img>
                    <span className="app-icon-name">translate</span>
                </a>
                <a className="app-icon" href="/">
                    <img alt="" className="app-icon-image" src={photo_icon}></img>
                    <span className="app-icon-name">Photo</span>
                </a>
                <a className="app-icon" href="/">
                    <img alt="" className="app-icon-image" src={shopping_icon}></img>
                    <span className="app-icon-name">Shopping</span>
                </a>
                <a className="app-icon" href="/">
                    <img alt="" className="app-icon-image" src={duo_icon}></img>
                    <span className="app-icon-name">Duo</span>
                </a>
                <a className="app-icon" href="/">
                    <img alt="" className="app-icon-image" src={meet_icon}></img>
            ...
            <div className="apps-icon-section flexbox">
                <a className="app-icon" href="/">
                    <img alt="" className="app-icon-image" src={finance_icon}></img>
                    <span className="app-icon-name">Finance</span>
                </a>
                <a className="app-icon" href="/">
                    <img alt="" className="app-icon-image" src={docs_icon}></img>
                    <span className="app-icon-name">Docs</span>
                </a>
                <a className="app-icon" href="/">
                    <img alt="" className="app-icon-image" src={sheet_icon}></img>
                    <span className="app-icon-name">Sheet</span>
                </a>
                <a className="app-icon" href="/">
                    <img alt="" className="app-icon-image" src={slide_icon}></img>
                    <span className="app-icon-name">Slide</span>
                </a>
                <a className="app-icon" href="/">
                    <img alt="" className="app-icon-image" src={books_icon}></img>
                    <span className="app-icon-name">Books</span>
                </a>
                <a className="app-icon" href="/">
                    <img alt="" className="app-icon-image" src={blogger_icon}></img>
                    <span className="app-icon-name">Blogger</span>
                </a>
                <a className="app-icon" href="/">
                    <img alt="" className="app-icon-image" src={hangouts_icon}></img>
                    <span className="app-icon-name">Hangouts</span>
                </a>
                <a className="app-icon" href="/">
                    <img alt="" className="app-icon-image" src={keep_icon}></img>
                    <span className="app-icon-name">Keep</span>
                </a>
                <a className="app-icon" href="/">
                    <img alt="" className="app-icon-image" src={jamboard_icon}></img>
                    <span className="app-icon-name">Jamboard</span>
                </a>
                <a className="app-icon" href="/">
                    <img alt="" className="app-icon-image" src={earth_icon}></img>
                    <span className="app-icon-name">Earth</span>
                </a>
                <a className="app-icon" href="/">
                    <img alt="" className="app-icon-image" src={collections_icon}></img>
                    <span className="app-icon-name">Collections</span>
                </a>
                <a className="app-icon" href="/">
                    <img alt="" className="app-icon-image" src={arts_icon}></img>
